...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden min-h-[60vh] md:min-h-[65vh] flex items-center">
      ...
      <div className="absolute inset-0">
        {slides.map((slide, index) => (
          ...
          >
            {/* Background Overlay */}
            <div className="absolute inset-0 bg-gradient-to-br from-pepe-primary/30 to-pepe-secondary/20 z-0" />
      ...
      <div className="container relative z-10 mx-auto px-4 py-8 md:py-12">
        <div className="max-w-2xl">
          {/* Content without translucent background */}
          <div className="text-white">
            <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mb-6 leading-tight drop-shadow-lg">
              Delicious <span className="text-yellow-300">Brunch</span> 
              <br />
              Delivered to Your Door
            </h1>
            <p className="text-lg text-white/95 mb-8 leading-relaxed drop-shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                href="/products" 
                className="px-8 py-3 bg-gradient-to-r from-pepe-primary to-pink-600 text-white font-semibold rounded-xl hover:shadow-xl hover:scale-105 transition-all duration-300 text-center flex items-center justify-center gap-2 group shadow-lg"
              >
                Order Now
              ...
              <Link 
                href="/about" 
                className="px-8 py-3 bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white font-semibold rounded-xl hover:bg-white/20 transition-all duration-300 text-center shadow-lg"
              >
                Explore Menu
              </Link>
            </div>
            ...
            <div className="mt-10 grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-white/80 drop-shadow">Menu Items</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white drop-shadow-lg">4.9⭐</div>
                <div className="text-sm text-white/80 drop-shadow">Customer Rating</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-white drop-shadow-lg">30min</div>
                <div className="text-sm text-white/80 drop-shadow">Avg Delivery</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Decorative Elements */}
      <div className="absolute top-0 right-0 w-48 h-48 bg-pepe-primary/20 rounded-full -translate-y-24 translate-x-24 animate-float-slow"></div>
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-pepe-secondary/30 rounded-full translate-y-32 -translate-x-32 animate-float-slow delay-1000"></div>

      {/* Floating Icons - Smaller and less prominent */}
      <div className="hidden md:block absolute top-16 left-8 text-3xl animate-float z-10 opacity-80">🥐</div>
      <div className="hidden md:block absolute bottom-32 right-16 text-4xl animate-float delay-500 z-10 opacity-80">☕</div>
      <div className="hidden md:block absolute top-32 right-8 text-5xl animate-float delay-1000 z-10 opacity-80">🥞</div>
...
//           >
//             {/* Background Overlay */}
//             <div className="absolute inset-0 bg-gradient-to-br from-pepe-primary/20 to-pepe-secondary/10 z-0" />
...
//           <div className="bg-white/85 backdrop-blur-sm rounded-3xl p-8 md:p-10 border border-white/20 shadow-2xl">
...
//       {/* Floating Icons */}
//       <div className="absolute top-20 left-10 text-4xl animate-float z-10">🥐</div>
//       <div className="absolute bottom-40 right-20 text-5xl animate-float delay-500 z-10">☕</div>
//       <div className="absolute top-40 right-10 text-6xl animate-float delay-1000 z-10">🥞</div>
